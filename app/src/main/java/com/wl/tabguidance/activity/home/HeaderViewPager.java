 ...
 *  //TODO layout 中：
 *     <HeaderViewPager
 *               android:id="@+id/head_circle_main_page"
 *               android:layout_width="match_parent"
 *               android:layout_height="match_parent"
 *               android:orientation="vertical"
 *               app:hvp_topOffset="40dp">
 *               <View
 *                     添加 viewPager 的公共头部 view
 *               />
 *               <TabLayout>
 *                   // 导航标题，可以使用 TabLayout，或 自定义的 string layout {@link android.support.design.widget.TabLayout}（如有需要可查看源码）
 *               </TabLayout>
 *
 *               <ViewPager>
 *                   // ViewPager
 ...
 *             (R.id.head_circle_main_page).setTranslationY(currentY / 2);
 *            //动态改变标题栏的透明度,注意转化为浮点型
 *             float alpha = 1.0f * currentY / maxY;
 *             rlHeaderToolbarLayout.setAlpha(alpha);
 *            }
 *     });
 *
 *
 ...
 *     }
 *
 *      //TODO 方式一 使用 TabLayout {@link android.support.design.widget.TabLayout}:
 *
 *      //TODO 方式二 使用自定义 string layout:
 *      TabLayoutTitleStrip.setTitles(params stringTitleLabler);
 *      ViewPager.setAdapter(new ContentAdapter(getSupportFragmentManager()));
 *      TabLayoutTitleStrip.setViewPager(mViewPager);
 *      scrollableLayout.setCurrentScrollableContainer(fragments.get(0));
 *      TabLayoutTitleStrip.setTabIndex(0);
 ...
 *          HeaderViewPager.setTopOffset(rlHeaderToolbarLayout.getHeight());
 *      }
 *
 * </pre>
 *
