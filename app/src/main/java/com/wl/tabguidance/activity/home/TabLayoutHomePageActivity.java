...
public class TabLayoutHomePageActivity extends HomePageBaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tablayout_home_page);
    ...
    protected void initView() {
        ...
        findViewById(R.id.btn1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(TabLayoutHomePageActivity.this,"kdklas",Toast.LENGTH_SHORT).show();
                setPager();
            }
        });
...
//                pagerHeader.setTranslationY(currentY / 2);
    ...
    public String[] titl = new String[]{"ScrollView", "ListView"};
    @Override
