package com.wl.tabguidance.fragments.homepage;//package com.stone.pager.fragment;
...
public class RecyclerViewFragment extends HeaderViewPagerFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_homepage_recyclerview, container, false);
